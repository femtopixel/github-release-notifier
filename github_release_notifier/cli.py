...
import argparse,notifier,webhook
...
def main():
    ...
    parser.add_argument("--action", '-a',
                        ...
                        help="Action to do (default: cron) (options:'cron', 'subscribe', 'unsubscribe')")
    parser.add_argument("--package", '-p', help="Github package name / url (required for subscribe/unsubscribe) - prints uuid on subscription")
